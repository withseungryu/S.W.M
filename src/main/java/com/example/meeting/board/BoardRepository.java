...
public interface BoardRepository extends JpaRepository<Board, Long> {
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?1 WHERE b.createdDate >= ?2 AND b.createdDate <= ?3")
        public Page<Object[]> getfindNullAll(User user, Timestamp date1, Timestamp date2,  Pageable pageable);

        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?1 WHERE b.createdDate >= ?2 AND b.createdDate <= ?3 AND b.gender like ?4")
        public Page<Object[]> getfindAll(User user, Timestamp date1, Timestamp date2, String gender, Pageable pageable);

        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?3 WHERE b.location1 like ?1 AND b.location2 like ?2 AND b.createdDate >= ?4 AND b.createdDate <= ?5 AND b.gender like ?6 ")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?2 WHERE b.num_type like ?1 AND b.createdDate >= ?3 AND b.createdDate <= ?4 AND b.gender like ?5")
        public Page<Object[]> getList2(String num_type, User user, Timestamp date1, Timestamp date2, String gender, Pageable pageable);

        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?3 WHERE b.age <= ?1 and b.age >= ?2 AND b.createdDate >= ?4 AND b.createdDate <= ?5 AND b.gender like ?6")
        public Page<Object[]> getList3(int age1, int age2,User user, Timestamp date1, Timestamp date2, String gender, Pageable pageable);

        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?4 WHERE b.location1 like ?1 AND b.location2 like ?2 and b.num_type like ?3 AND b.createdDate >= ?5 AND b.createdDate <= ?6 AND b.gender like ?7")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?5 WHERE b.location1 like ?1 AND b.location2 like ?2  and b.age <= ?3 and b.age >= ?4 AND b.createdDate >= ?6 AND b.createdDate <= ?7 AND b.gender like ?8")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?4 WHERE b.num_type like ?1 and b.age <= ?2 and b.age >= ?3 AND b.createdDate >= ?5 AND b.createdDate <= ?6 AND b.gender like ?7")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?6 WHERE b.location1 like ?1 AND b.location2 like ?2 and b.num_type like ?3 and b.age <= ?4 and b.age >= ?5 AND b.createdDate >= ?7 AND b.createdDate <= ?8 AND b.gender like ?9")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?2 WHERE b.location1 like ?1 AND b.createdDate >= ?3 AND b.createdDate <= ?4 AND b.gender like ?5")
        public Page<Object[]> getList8(String location1, User user, Timestamp date1, Timestamp date2, String gender, Pageable pageable);

        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?4 WHERE b.location1 like ?1and b.age <= ?2 and b.age >= ?3 AND b.createdDate >= ?5 AND b.createdDate <= ?6 AND b.gender like ?7")
        ...
        @Query("SELECT b, m FROM Board b LEFT JOIN Bookmark m ON b.idx = m.board.idx AND m.user = ?5 WHERE b.location1 like ?1 AND  b.num_type like ?2 and b.age <= ?3 and b.age >= ?4 AND b.createdDate >= ?6 AND b.createdDate <= ?7 AND b.gender like ?8")
